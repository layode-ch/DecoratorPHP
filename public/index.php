...
// Theme::$BORDER_RADIUS = (int)$_GET["border-radius"];
Theme::$BASE_BACKGROUND_COLOR = $_GET["base-bg"] ?? "neutral-200";
Theme::$ACCENT_BACKGROUND_COLOR = $_GET["accent-bg"] ?? "blue-400";
    ...
    <div class="flex w-[100vw] h-[100vh]">
        <div class="w-1/5 h-full bg-neutral-50">
            ...
            <form class="p-4 gap-4 flex flex-col">
                ...
                <input name="border-radius" type="range" min="0" max="9" value="<?= Theme::$BORDER_RADIUS ?>">

                <label for="base-bg">Base background</label>
                <ul class="flex gap-4">
                    <input type="radio" name="base-bg" value="neutral-200" class="appearance-none w-10 h-10 bg-neutral-200">
                    <input type="radio" name="base-bg" value="neutral-400"class="appearance-none w-10 h-10 bg-neutral-400">
                    <input type="radio" name="base-bg" value="neutral-600" class="appearance-none w-10 h-10 bg-neutral-600">
                </ul>

                <label for="accent-bg">Accent background</label>
                <ul class="flex gap-4">
                    <input type="radio" name="accent-bg" value="blue-300" class="appearance-none w-10 h-10 bg-blue-300">
                    <input type="radio" name="accent-bg" value="red-300"class="appearance-none w-10 h-10 bg-red-300">
                    <input type="radio" name="accent-bg" value="green-300" class="appearance-none w-10 h-10 bg-green-300">
                </ul>
