...
--
-- Hôte : localhost
-- Généré le : sam. 22 jan. 2022 à 08:02
...
CREATE TABLE `films` (
  ...
  `annee` year(4) NOT NULL DEFAULT 2000,
  `idPersonne` int(10) UNSIGNED DEFAULT NULL COMMENT 'Metteur en scène',
  `idGenre` int(10) UNSIGNED DEFAULT NULL,
  `resume` mediumtext DEFAULT NULL,
  `idPays` varchar(4) DEFAULT NULL
...
INSERT INTO `pays` (`idPays`, `nom`, `langue`) VALUES
('CH', 'Suisse', 'Français'),
...
CREATE TABLE `personnes` (
  ...
  `anneeNaissance` year(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `personnes` (`idPersonne`, `nom`, `prenom`, `anneeNaissance`) VALUES
(3, 'Hitchcock', 'Alfred', 0000),
(4, 'Scott', 'Ridley', 1937),
...
(225, 'Penn', 'Sean', 1960),
(226, 'Beineix', 'Jean-Jacques', 1946),
(227, 'Annaud', 'Monique', 1945),
(228, 'Connery', 'Jason', 1963);
...
CREATE TABLE `roles` (
  `idFilm` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `idPersonne` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'Acteur',
...
INSERT INTO `roles` (`idFilm`, `idPersonne`, `nomRole`) VALUES
(1, 15, 'John Ferguson'),
...
--
ALTER TABLE `films`
  MODIFY `idFilm` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT pour la table `genres`
--
ALTER TABLE `genres`
  MODIFY `idGenre` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT pour la table `personnes`
--
ALTER TABLE `personnes`
  MODIFY `idPersonne` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=229;
...
--
ALTER TABLE `films`
  ADD CONSTRAINT `films_ibfk_1` FOREIGN KEY (`idPersonne`) REFERENCES `personnes` (`idPersonne`),
  ADD CONSTRAINT `films_ibfk_2` FOREIGN KEY (`idGenre`) REFERENCES `genres` (`idGenre`),
  ADD CONSTRAINT `films_ibfk_3` FOREIGN KEY (`idPays`) REFERENCES `pays` (`idPays`);

--
-- Contraintes pour la table `roles`
--
ALTER TABLE `roles`
  ADD CONSTRAINT `roles_ibfk_1` FOREIGN KEY (`idFilm`) REFERENCES `films` (`idFilm`),
  ADD CONSTRAINT `roles_ibfk_2` FOREIGN KEY (`idPersonne`) REFERENCES `personnes` (`idPersonne`);
COMMIT;
