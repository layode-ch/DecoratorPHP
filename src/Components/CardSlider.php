...
class CardSlider extends Card
{
    public function __construct(int $cols = 1, int $rows = 1)
    {
        ...
        $this->textContent = '<div class="text-black h-full w-full flex flex-col items-center gap-4 py-2">
    <h2 class="flex items-center justify-between">
        <span class="text-black flex items-center gap-2 font-semibold">
    ...
    <div class="text-black text-center text-5xl font-extralight">50</div> 
