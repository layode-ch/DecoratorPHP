...
class Alert extends Component
{
    ...
    public function toHTML(): string
    {
        ...
        return "<div class='$classes flex justify-between'><p> $this->message </p><svg class='mt-1' xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-x-lg' viewBox='0 0 16 16'>
